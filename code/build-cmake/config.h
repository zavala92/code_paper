...
/* Define to 1 if you have module code available */
#define HAVE_CODE 1
...
#define PACKAGE_NAME "code"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "code 1.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "code"
...
/* Define to the version of code */
#define CODE_VERSION "1.0"

/* Define to the major version of code */
#define CODE_VERSION_MAJOR 1

/* Define to the minor version of code */
#define CODE_VERSION_MINOR 0

/* Define to the revision of code */
#define CODE_VERSION_REVISION 0
...
/* SPGRID not available, enable with cmake variable DUNE_GRID_GRIDTYPE_SELECTOR=ON */
/* SPGRID_SERIAL not available, enable with cmake variable DUNE_GRID_GRIDTYPE_SELECTOR=ON */
/* SPGRID_ISOTROPIC not available, enable with cmake variable DUNE_GRID_GRIDTYPE_SELECTOR=ON */
/* SPGRID_ANISOTROPIC not available, enable with cmake variable DUNE_GRID_GRIDTYPE_SELECTOR=ON */
/* SPGRID_BISECTION not available, enable with cmake variable DUNE_GRID_GRIDTYPE_SELECTOR=ON */
/* SPGRID_ISOTROPIC_SERIAL not available, enable with cmake variable DUNE_GRID_GRIDTYPE_SELECTOR=ON */
/* SPGRID_ANISOTROPIC_SERIAL not available, enable with cmake variable DUNE_GRID_GRIDTYPE_SELECTOR=ON */
/* SPGRID_BISECTION_SERIAL not available, enable with cmake variable DUNE_GRID_GRIDTYPE_SELECTOR=ON */
/* SPGRID_COUNT_FLOPS not available, enable with cmake variable DUNE_GRID_GRIDTYPE_SELECTOR=ON */
